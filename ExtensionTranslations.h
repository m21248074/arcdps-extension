...
constexpr auto EXTENSION_TRANSLATION_FRENCH = std::to_array({
	...
	u8"Taille à contenu",	//     ET_SizingPolicySizeToContent,
	u8"Taille du contenu par rapport à la fenêtre",	//     ET_SizingPolicySizeContentToWindow,
	u8"Taille de la fenêtre Manuel",	//     ET_SizingPolicyManualWindowSize,
	...
	u8"Politique de dimensionnement", // ET_SizingPolicy
	...
	u8"Mettre en évidence la ligne survolée", // ET_HighlightHoveredRow
